...
public class BloomFilter<E> implements Serializable {
    private FileBackedBitSet bitset;
    ...
    static final HashFunction digestFunction = Hashing.murmur3_128();
     ...
     */
    public BloomFilter(String fileName, double c, int n, int k) {
        this.expectedNumberOfFilterElements = n;
        this.k = k;
        this.bitsPerElement = c;
        this.bitSetSize = (int) Math.ceil(c * n);
        numberOfAddedElements = 0;
        this.bitset = new FileBackedBitSet(fileName,bitSetSize);
    }
     ...
     */
    public BloomFilter(String fileName, int bitSetSize, int expectedNumberOElements) {
        this(fileName, bitSetSize / (double) expectedNumberOElements,
     ...
     */
    public BloomFilter(String fileName, double falsePositiveProbability, int expectedNumberOfElements) {
        this(fileName, Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))) / Math.log(2), // c = k / ln(2)
    ...
    public static int[] createHashes(byte[] data, int hashes) {
        ...
        int k = 0;
        while (k < hashes) {
            byte[] digest = digestFunction.hashBytes(data).asBytes();
     ...
     */
    public FileBackedBitSet getBitSet() {
        return bitset;
    }
