...
final class SnappyInternalUtils
{
    ...
    static {
        ...
        if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
            try {
                Class<? extends Memory> unsafeMemoryClass = SnappyInternalUtils.class.getClassLoader().loadClass("io.trivium.dep.org.iq80.snappy.UnsafeMemory").asSubclass(Memory.class);
        ...
        if (memoryInstance == null) {
            try {
                Class<? extends Memory> slowMemoryClass = SnappyInternalUtils.class.getClassLoader().loadClass("io.trivium.dep.org.iq80.snappy.SlowMemory").asSubclass(Memory.class);
