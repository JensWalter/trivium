...
import io.trivium.dep.com.google.common.util.concurrent.ForwardingListenableFuture.SimpleForwardingListenableFuture;
...
public final class MoreExecutors {
  ...
  public static ThreadFactory platformThreadFactory() {
    ...
    try {
      return (ThreadFactory) Class.forName("io.trivium.dep.com.google.appengine.api.ThreadManager")
  ...
  private static boolean isAppEngine() {
    if (System.getProperty("io.trivium.dep.com.google.appengine.runtime.environment") == null) {
      return false;
    }
    try {
      // If the current environment is null, we're not inside AppEngine.
      return Class.forName("io.trivium.dep.com.google.apphosting.api.ApiProxy")
