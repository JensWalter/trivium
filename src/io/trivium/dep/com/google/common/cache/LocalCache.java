...
package io.trivium.dep.com.google.common.cache;
...
import static io.trivium.dep.com.google.common.cache.CacheBuilder.NULL_TICKER;
import static io.trivium.dep.com.google.common.cache.CacheBuilder.UNSET_INT;
import static io.trivium.dep.com.google.common.util.concurrent.MoreExecutors.directExecutor;
import static io.trivium.dep.com.google.common.util.concurrent.Uninterruptibles.getUninterruptibly;
import static java.util.concurrent.TimeUnit.NANOSECONDS;

import io.trivium.dep.com.google.common.annotations.GwtCompatible;
import io.trivium.dep.com.google.common.annotations.GwtIncompatible;
import io.trivium.dep.com.google.common.annotations.VisibleForTesting;
import io.trivium.dep.com.google.common.base.Equivalence;
import io.trivium.dep.com.google.common.base.Function;
import io.trivium.dep.com.google.common.base.Stopwatch;
import io.trivium.dep.com.google.common.base.Ticker;
import io.trivium.dep.com.google.common.cache.AbstractCache.SimpleStatsCounter;
import io.trivium.dep.com.google.common.cache.AbstractCache.StatsCounter;
import io.trivium.dep.com.google.common.cache.CacheBuilder.NullListener;
import io.trivium.dep.com.google.common.cache.CacheBuilder.OneWeigher;
import io.trivium.dep.com.google.common.cache.CacheLoader.InvalidCacheLoadException;
import io.trivium.dep.com.google.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import io.trivium.dep.com.google.common.collect.AbstractSequentialIterator;
import io.trivium.dep.com.google.common.collect.ImmutableMap;
import io.trivium.dep.com.google.common.collect.ImmutableSet;
import io.trivium.dep.com.google.common.collect.Iterators;
import io.trivium.dep.com.google.common.collect.Maps;
import io.trivium.dep.com.google.common.collect.Sets;
import io.trivium.dep.com.google.common.primitives.Ints;
import io.trivium.dep.com.google.common.util.concurrent.ExecutionError;
import io.trivium.dep.com.google.common.util.concurrent.Futures;
import io.trivium.dep.com.google.common.util.concurrent.ListenableFuture;
import io.trivium.dep.com.google.common.util.concurrent.SettableFuture;
import io.trivium.dep.com.google.common.util.concurrent.UncheckedExecutionException;
import io.trivium.dep.com.google.common.util.concurrent.Uninterruptibles;
import io.trivium.dep.com.google.j2objc.annotations.Weak;
import io.trivium.dep.com.google.j2objc.annotations.WeakOuter;
 ...
 *
 * @author Charles Fry
 * @author Bob Lee ({@code io.trivium.dep.com.google.common.collect.MapMaker})
